...
export class MenuTester {
     ...
     */
    private async testMouseInteractions(menuItem: Locator): Promise<{
        ...
        if (expandedElement) {
            ...
            if(!!visibleDropdownElement) {
                ...
                try {
                    ...
                    await this.page.waitForTimeout(500); // Wait for dropdown animation, if any
            ...
            if (visibleDropdownElement) {
                ...
                try {
                    ...
                    if (dropdownVisibleAfterHover) {
                        ...
                        // Try keyboard interaction after hover
                        await this.page.keyboard.press('Enter');
                        await this.page.waitForTimeout(300);
                ...
                try {
                    console.log(`\n=== TESTING CLICK INTERACTION FOR KEYBOARD ACCESS ===`);
                    ...
                    if (hasChildren) {
                        ...
                        if (dropdownVisibleAfterClick !== initialDropdownVisible) {
                            console.log(`✅ Dropdown visibility changed after click`);
                            
                            // Try keyboard interaction after click
                            await this.page.keyboard.press('Enter');
                            await this.page.waitForTimeout(300);
                            ...
                            const dropdownClosedAfterEscape = !(await menuItem.locator('ul').isVisible());
                            
                            return {
                                isAccessible: true,
                                opensOnEnter: true,
                                opensOnSpace: false,
                                closesOnEscape: dropdownClosedAfterEscape
                            };
                        }
                    }
                } catch (error) {
        ...
        if (dropdownCount > 0) {
            ...
            for (let j = 0; j < dropdownCount; j++) {
                ...
                if (keyboardResult.isAccessible) {
                    ...
                    const mouseResult = await this.testMouseInteractions(dropdownItem);
